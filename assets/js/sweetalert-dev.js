!function (e, t) {
        ...
        Z = function (e) {
            ...
            if (t && (t.parentNode.removeChild(t), N([document.documentElement, document.body], [I["no-backdrop"], I["toast-shown"], I["has-column"]])), !j()) {
                ...
                var p = void 0, f = function (e) {
                    Oe.isVisible() && p !== e.target.value && Oe.resetValidationError(), p = e.target.value
                };
            ...
            if (e.type) if (-1 !== Object.keys(f).indexOf(e.type)) {
                var o = Oe.getPopup().querySelector("." + I.icon + "." + f[e.type]);
            ...
            var i = A(), a = parseInt(null === r.currentProgressStep ? Oe.getQueueStep() : r.currentProgressStep, 10);
    ...
    var ae = {
        ...
        ce = function (e) {
            ...
            for (var t in e) ce(t) || d('Unknown parameter "' + t + '"'), e.toast && -1 !== ue.indexOf(t) && d('The parameter "' + t + '" is incompatible with toasts'), le(t) && l('The parameter "' + t + '" is deprecated and will be removed in the next major release.')
        },
    ...
    var me = [], he = function () {
            ...
            queue: function (e) {
                ...
                me = e;
                var a = function () {
                    me = [], document.body.removeAttribute("data-swal2-queue-step")
                }, s = [];
                return new Promise(function (r) {
                    !function t(n, o) {
                        n < me.length ? (document.body.setAttribute("data-swal2-queue-step", n), i(me[n]).then(function (e) {
            ...
            insertQueueStep: function (e, t) {
                return t && t < me.length ? me.splice(t, 0, e) : me.push(e)
            },
            deleteQueueStep: function (e) {
                void 0 !== me[e] && me.splice(e, 1)
            },
            showLoading: he,
            enableLoading: he,
        ...
        }(), ve = "function" == typeof WeakMap ? WeakMap : function (n, o, t) {
            function e() {
        ...
        ye = {promise: new ve, innerParams: new ve, domCache: new ve};

    function we() {
        var e = ye.innerParams.get(this), t = ye.domCache.get(this);
    ...
    var Ae = Object.freeze({
        hideLoading: we, disableLoading: we, getInput: function (e) {
            var t = ye.innerParams.get(this), n = ye.domCache.get(this);
            ...
            var e = ye.domCache.get(this);
            e.confirmButton.disabled = !1, e.cancelButton.disabled = !1
        }, disableButtons: function () {
            var e = ye.domCache.get(this);
            e.confirmButton.disabled = !0, e.cancelButton.disabled = !0
        }, enableConfirmButton: function () {
            ye.domCache.get(this).confirmButton.disabled = !1
        }, disableConfirmButton: function () {
            ye.domCache.get(this).confirmButton.disabled = !0
            ...
            return ye.innerParams.get(this).progressSteps
        }, setProgressSteps: function (e) {
            var t = ye.innerParams.get(this), n = r({}, t, {progressSteps: e});
            ye.innerParams.set(this, n), ee(n)
            ...
            !function (t) {
                t.inputValidator || Object.keys(ke).forEach(function (e) {
                    t.input === e && (t.inputValidator = t.expectRejections ? ke[e] : Oe.adaptInputValidator(ke[e]))
            ...
            }(T), Object.freeze(T), ye.innerParams.set(this, T), oe.timeout && (oe.timeout.stop(), delete oe.timeout), clearTimeout(oe.restoreFocusTimeout);
            var j = {
                popup: y(),
                container: b(),
                content: k(),
            ...
            return new Promise(function (t, n) {
                ...
                T.timer && (oe.timeout = new Ce(function () {
                ...
                xe(T), T.toast || (M(T.allowEnterKey) ? T.focusCancel && F(j.cancelButton) ? j.cancelButton.focus() : T.focusConfirm && F(j.confirmButton) ? j.confirmButton.focus() : s(-1, 1) : document.activeElement && document.activeElement.blur()), j.container.scrollTop = 0
            })
        }
    }), Be = void 0;
    ...
    function Pe() {
        if ("undefined" != typeof window) {
            ...
            ye.promise.set(this, r)
        }
    }

    Pe.prototype.then = function (e, t) {
        return ye.promise.get(this).then(e, t)
    }, Pe.prototype.catch = function (e) {
        return ye.promise.get(this).catch(e)
    }, Pe.prototype.finally = function (e) {
        return ye.promise.get(this).finally(e)
    }, r(Pe.prototype, Ae), r(Pe, ge), Object.keys(Ae).forEach(function (t) {
        Pe[t] = function () {
            var e;
            if (Be) return (e = Be)[t].apply(e, arguments)
        }
    }), Pe.DismissReason = e, Pe.noop = function () {
    }, Pe.version = "7.26.14";
    var Se, Ee, Oe = ie((Se = Pe, Ee = function (e) {
        function t() {
            return s(this, t), u(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments))
        }
        ...
        return a(t, Se), o(t, [{
            key: "_main", value: function (e) {
                return i(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "_main", this).call(this, r({}, fe, e))
            }
        }], [{
            key: "setDefaults", value: function (t) {
                if (l(pe), !t || "object" !== (void 0 === t ? "undefined" : q(t))) throw new TypeError("SweetAlert2: The argument for setDefaults() is required and has to be a object");
                de(t), Object.keys(t).forEach(function (e) {
                    Se.isValidParameter(e) && (fe[e] = t[e])
                })
            }
        }, {
    ...
    }(), "undefined" != typeof window && "object" === q(window._swalDefaults) && Ee.setDefaults(window._swalDefaults), Ee));
